...
public class RestExtension implements ConcordionExtension {
  ...
  public void addTo(ConcordionExtender concordionExtender) {
    ...
    concordionExtender.withCommand(REST_EXTENSION_NS, "formBody", new FormBodyCommand());
    ...
    concordionExtender.withCommand(REST_EXTENSION_NS, "setVariableFromResponse", new SetResponseVariableValueCommand());
